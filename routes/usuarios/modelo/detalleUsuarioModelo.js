/* INICIO - WS LISTAR DETALLE USUARIO*/
exports.listarDetalleUsuario = function(req) {
  ...
  return new Promise((resolve, reject) => {
    ...
    req.getConnection(function(error, database) {
      if (error) {
        ...
        WHERE usuarios.idUsuario = ${idUsuario} AND usuarios.estatusBL = 1
        `;
